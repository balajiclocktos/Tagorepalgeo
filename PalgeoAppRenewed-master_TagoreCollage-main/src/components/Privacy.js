  ...
  render() {
    return (
      <>
        ...
        />
        <VStack contentContainerStyle={{padding: '3%'}}>
          <Text style={styles.text}>
            Privacy Policy for Palgeo This Privacy Policy document contains
            types of information that is collected and recorded by Palgeo and
            ...
            that they shared and/or collect in Palgeo. This policy is not
            applicable to any information collected offline or via channels
            other than this website. Consent By using our website, you hereby
            consent to our Privacy Policy and agree to its terms. Information we
            collect The personal information that you are asked to provide, and
            the reasons why you are asked to provide it, will be made clear to
            ...
            maintain our webste Improve, personalize, and expand our webste
            ...
            to the webste, and for marketing and promotional purposes Send you
            emails Find and prevent fraud Log Files Palgeo follows a standard
            ...
            Palgeo. Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Palgeo, which are
            ...
            Note that Palgeo has no access to or control over these cookies that
            are used by third-party advertisers. Third Party Privacy Policies
            Palgeo's Privacy Policy does not apply to other advertisers or
            ...
            online activity. Palgeo does not knowingly collect any Personal
